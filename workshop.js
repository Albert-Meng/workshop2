...
const EVENT_LOCATION = "Hybrid (Toronto: Victor Phillip Dahdaleh Building (DB) 2118 / Vancouver: TASC 1 9204 / Online: Zoom)";
...
const MEETING_URL = "https://yorku.zoom.us/j/95599140705?pwd=7j8MgZQ8U9NxoUzAbF7UdIoENJYpTr.1"; // Replace with the actual online meeting URL when available.
...
const AGENDA = [
  ...
  {
    type: "KEYNOTE",
    startISO: "2026-03-12T12:10:00-04:00",
    title: "Securing Logistics: The Central Role of Cybersecurity for Transportation Safety.",
    speakers: ["Margaret McKay (Director of NRC AI for Logistics Program)"],
    mode: "Hybrid",
    details: "This talk provides an overview of the National Research Council Canada’s AI for Logistics Program, sheds light on the cybersecurity challenges introduced by applying AI technologies in this domain, and underscores how research in AI security and robustness can help address these challenges."
  },
  {
    type: "KEYNOTE",
  ...
  },
  {
    type: "NETWORK",
    startISO: "2026-03-12T15:40:00-04:00",
    title: "Onsite Poster Session/Networking",
    speakers: [],
    mode: "In-person",
...
const PEOPLE = [
    ...
    },
  {
      ...
      role: "Director of NRC AI for Logistics Program",
      photo: "assets/people/margaret-mckay.jpg",
      links: [],
      bio: "Margaret McKay leads the AI for Logistics R&D program at the National Research Council of Canada. Previously, she has held a variety of management and advisory roles in program and project management, performance measurement, policy and risk, and intellectual property law. She holds a B.Sc. and M.Sc. in biochemistry from McMaster University, a J.D. from the University of Toronto, and an LL.M. in Privacy and Cybersecurity from Osgoode Hall. She is admitted to the bars of Ontario and New York, is a registered patent agent and trade-mark agent with the Canadian Intellectual Property Office, and holds certifications as a Project Management Professional (PMI) and a Certified Information Privacy Professional (Canada, IAPP)."
    },
  {
      group: "ORGANIZER",
      name: "Dr. Dilli Prasad Sharma",
    ...
    },
  {
      ...
      org: "University of Guelph",
      role: "Team Member",
      photo: "assets/people/qingxin-meng.jpg",
      links: [],
      bio: "Qingxin Meng is a master student of Cybersecurity and Threat Intelligence (MCTI) in University of Guelph."
    }
];
...
function buildPdfScheduleCard(it) {
  ...
  // Type labels (e.g., KEYNOTE/BREAK/NETWORK) are intentionally hidden in the web schedule.
  // Keep the underlying `type` field for filtering, but do not render it in the UI/PDF.
...
function initMeetingLinks() {
  ...
  ids.forEach((id) => {
    ...
    const customLabel = el.dataset.linkLabel || "";
    el.textContent = url ? (customLabel || url) : "TBA";
...
function initCopyButtons() {
  ...
  pairs.forEach(([btnId, linkId]) => {
    ...
    btn.addEventListener("click", async () => {
      const valueToCopy = (link.getAttribute("href") || "").startsWith("http")
